  ...
  return (
    <div className="p-4 bg-white rounded-2xl polo-border polo-shadow space-y-3">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="p-3 bg-red-50 rounded-xl border-2 border-[#B82126]">
          <span className="text-[10px] font-extrabold uppercase text-[#B82126] tracking-wider">Primary Emotion</span>
