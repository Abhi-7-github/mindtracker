...
export const Footer = () => {
  return (
    <footer className="bg-black text-white border-t-4 border-[#9F1239] py-12 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <div className="flex items-center space-x-2 mb-4">
            <div className="w-8 h-8 bg-[#9F1239] rounded-lg border-2 border-white flex items-center justify-center font-black">
              P
            </div>
            <span className="text-lg font-black uppercase tracking-tight">POLO AI</span>
          </div>
        ...
        <div>
          <h5 className="text-xs font-black uppercase text-[#9F1239] mb-3 tracking-wider">Features</h5>
        ...
        <div>
          <h5 className="text-xs font-black uppercase text-[#9F1239] mb-3 tracking-wider">Account</h5>
          <ul className="space-y-2 text-xs font-bold text-neutral-300">
        ...
        <div>
          <h5 className="text-xs font-black uppercase text-[#9F1239] mb-3 tracking-wider">Safety & Notice</h5>
          <p className="text-[11px] text-neutral-400 leading-relaxed">
            POLO AI assessments are AI-generated and provide supportive wellness insight. They do not constitute formal medical advice or emergency medical intervention.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto mt-8 pt-6 border-t border-neutral-800 flex flex-col sm:flex-row items-center justify-between text-xs font-bold text-neutral-500">
        <p>© 2026 POLO AI. Built with POLO Design System.</p>
