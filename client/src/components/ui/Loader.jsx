  ...
  return (
    <div className={cn("flex flex-col items-center justify-center p-8 space-y-4", className)}>
      <div className="flex items-center space-x-1.5 h-10">
        <span className="w-2.5 bg-[#9F1239] rounded-full h-full animate-wave-bar polo-border" style={{ animationDelay: '0s' }} />
        <span className="w-2.5 bg-black rounded-full h-full animate-wave-bar polo-border" style={{ animationDelay: '0.2s' }} />
        <span className="w-2.5 bg-[#9F1239] rounded-full h-full animate-wave-bar polo-border" style={{ animationDelay: '0.4s' }} />
