...
export const NotificationCard = ({ notification, onMarkRead }) => {
  ...
  return (
    <Card className={`p-4 transition-colors ${read ? 'bg-neutral-50 opacity-75' : 'bg-white border-l-4 border-l-[#9F1239]'}`}>
      <div className="flex items-start space-x-3">
        <div className={`p-2 rounded-lg polo-border ${read ? 'bg-neutral-200 text-neutral-600' : 'bg-[#9F1239] text-white'}`}>
